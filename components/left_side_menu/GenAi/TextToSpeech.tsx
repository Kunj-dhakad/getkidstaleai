                                ...
                                <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <div className="relative flex items-center">
                                        <input
                                            type="search"
                                            placeholder="Search"
                                            className="bg-transparent text-white border border-gray-600 rounded px-4 py-2 pr-10 outline-none focus:ring-1 focus:ring-blue-500"
                                        />
                                        <span className="absolute right-3 text-gray-400 w-4 h-4"><IoSearch /></span>
                                    </div>
                                </div>
